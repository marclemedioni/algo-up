...
import anagrams from "../exercices/anagrams";
...
test('"A tree, a life, a bench" is not an anagram of "A tree, a fence, a yard"', async () => {
  expect(anagrams("A tree, a life, a bench", "A tree, a fence, a yard")).toEqual(false);
});
